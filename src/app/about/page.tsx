...
import { designers } from "@/lib/products";
        ...
        <div className="mx-auto max-w-4xl px-6 text-center md:px-10">
          ...
          <RevealOnScroll>
            ...
            <h1 className="font-serif text-5xl font-light leading-tight md:text-6xl">
              We believe light deserves to be treated like{" "}
              <span className="italic text-gold">sculpture</span>.
            </h1>
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-paper/60">
              SaFaLight exists to give a small circle of master designers the
              time, materials, and patience their work deserves — and to
              bring the result into homes that will keep it for generations.
            </p>
          </RevealOnScroll>
        </div>
      </section>
